...
class Belt extends Obj {
    constructor(GL, obj) {
        ...
        // console.log(this.verticesColors)
        ...
        newPathLengths.forEach((thepath, index) => {
            // if (index > 0) {
            //     this.texture_coords.push([thepath, 0.0]);
            //     this.texture_coords.push([newPathLengths[index - 1], 0.0]);
            //     this.texture_coords.push([newPathLengths[index - 1], 1.0]);

            //     this.texture_coords.push([thepath, 0.0]);
            //     this.texture_coords.push([newPathLengths[index - 1], 1.0]);
            //     this.texture_coords.push([thepath, 1.0]);
            // }
            // this.texture_coords
        ...
        // console.log(this.verticesColors, this.indices, this.texture_coords);
        ...
        // var grandient = ctx.createLinearGradient(0, 0, 0, 64);

        // ctx.fillStyle = grandient;
        // ctx.fillRect(0, 0, canvas.width, canvas.height);
        // ctx.fillStyle = 'white';
        // ctx.fillText(123131241412414, 10, 10);
        //
